    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                void Debug()
                {
                    Console.WriteLine("Count: " + egg.AmountLeft);
                    Console.WriteLine("Color Egg: " + egg.Color);
                    Console.WriteLine("Cooked Status: " + egg.CookedStatus);
                    Console.WriteLine("is Cooked: " + egg.IsCooked);
